# SPDX-License-Identifier: MIT
{
  ...
  inherit (deviceTools) stockBoot3001;

  # The exact stock vendor image contains ten MediaTek modules signed by the
  # certificate embedded in the matching stock kernel. Keep vendor/odm
  # byte-identical and add only this public certificate to the control
  # kernel's trusted keyring. The fixed offset is safe because both the OTA
  # and unpacked stock kernel hashes are independently pinned and checked.
